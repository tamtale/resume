...
\begin{resume}
    ...
    \textsl{President's Honor Roll, 2016, 2017} \vspace{1mm} \\
\textsl{Relevant coursework}: Program Design, Tools and Models for Data Science, Algorithms, Honors Linear Algebra, Computer Engineering, Differential Equations, Computer Systems, Parallel Programming}
